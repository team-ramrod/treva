...
case address is
    ...
    when "000000011" => q <= "0011100000000001";
    when "000000100" => q <= "0010000100000010";
    when "000000101" => q <= "0010100100000000";
    when "000000110" => q <= "0000000000000000";
    when "000000111" => q <= "0011100000000001";
    when "000001000" => q <= "0010000100000100";
    when "000001001" => q <= "0010100100000000";
    when "000001010" => q <= "0000000000000000";
    when "000001011" => q <= "0000000000000000";
    when "000001100" => q <= "0011100000000001";
    when "000001101" => q <= "0010000100000001";
    when "000001110" => q <= "0000000000000000";
    when "000001111" => q <= "0100101011110010";

...
case address is
    ...
    when "000010001" => q <= "0100101011110110";
    when "000010010" => q <= "0000000000000000";
    when "000010011" => q <= "0010000000000001";
    when "000010100" => q <= "0000100100000001";
    when "000010101" => q <= "0011100000000000";
    when "000010110" => q <= "0011000000000001";
    when "000010111" => q <= "0000000000000000";
    when "000011000" => q <= "0100100011101100";

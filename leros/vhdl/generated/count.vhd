...
case address is
    ...
    when "000000110" => q <= "0010000111111111";
    when "000000111" => q <= "0010100111111111";
    when "000001000" => q <= "0000110100000001";
    when "000001001" => q <= "0000000000000000";
    when "000001010" => q <= "0100101011111110";
    when "000001011" => q <= "0000000000000000";
    when "000001100" => q <= "0010000000000000";
    when "000001101" => q <= "0000110100000001";
    when "000001110" => q <= "0011000000000000";
    when "000001111" => q <= "0100101011110111";
    when "000010000" => q <= "0000000000000000";
    when "000010001" => q <= "0010000000000001";
    when "000010010" => q <= "0000100100000001";
    when "000010011" => q <= "0011100000000000";
    when "000010100" => q <= "0011000000000001";
    when "000010101" => q <= "0010000100000001";
